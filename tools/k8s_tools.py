...
def get_kubernetes_tools(k8s_client: KubernetesClient) -> List[BaseTool]:
    ...
    return [
        KubernetesListNamespacesTool(k8s_client=k8s_client),
        KubernetesListPodsTool(k8s_client=k8s_client),
        KubernetesListNodesTool(k8s_client=k8s_client),
        KubernetesListServicesTool(k8s_client=k8s_client),
        KubernetesGetClusterInfoTool(k8s_client=k8s_client)
    ]
